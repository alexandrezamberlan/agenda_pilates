...
from .views import (UsuarioListView, UsuarioPacienteListView, UsuarioCreateView, UsuarioPacienteCreateView, UsuarioUpdateView, 
					UsuarioPacienteUpdateView, UsuarioDeleteView)
...
urlpatterns = [
	...
	path('register', UsuarioRegisterView.as_view(), name='usuario_register'),
 	...
 	path('paciente/cad/', UsuarioPacienteCreateView.as_view(), name='usuario_paciente_create'),
	path('paciente/list/', UsuarioPacienteListView.as_view(), name='usuario_paciente_list'),
	path('paciente/<slug:slug>/', UsuarioPacienteUpdateView.as_view(), name='usuario_paciente_update'),
]
